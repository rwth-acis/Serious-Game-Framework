	  		...
	  		$.each(gameLevels, function(index, value) {
	  			...
	  			for(var i=0;i<NUMBER_OF_GALLERIES;i++){
	  				...
	  				if (pieceCounter[distinct]) {
	  					...
	  					var image = $('<li class="ui-widget-content ui-corner-tr piece" draggable="true"><img src="' + TILES_CONNECTIONS_PATH + p + '" alt="' +  p + '" width="115" height="86" id="piece-id-'+i+'" piece-id="' + p + '" piece-count="1"/></li>');
