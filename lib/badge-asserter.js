function BadgeAsserter () {
  this.host = "http://localhost:8383/Serious-Game-Framework/";
  this.badges_path = "data/badges/";
  this.assertions_path = this.badges_path + "assertions/";
  this.gleaner_frontend_host = "http://localhost:3000/"; // TODO MARKO use real location
  ...
  this.issueBadge = function (assertion_host_path, file_path) {
    ...
    this.assertBadgeConfigured = function (game_name, oidc_userinfo, badge_name, badge_src) {
    this.game_name = game_name || "other";
    this.user_info = oidc_userinfo;
    this.badge_name = badge_name || game_name;
    ...
    // issue the Badge
    this.issueBadgeConfigured([this.assertion_host_path], this.file_path)
  };

  this.issueBadgeConfigured = function (assertion_host_path, file_path) {
    // Play an achievement sound
    document.getElementById('achievement_sound').play();
